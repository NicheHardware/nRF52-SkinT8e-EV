PROJECT_NAME     := Comi-tempo-EV
TARGETS          := nrf52832_xxaa
OUTPUT_DIRECTORY := _build

SDK_PATH_WINDOWS := D:/_nRF_SDK_17.0.2
...
SRC_FILES += \
  ...
  $(PROJ_DIR)/module/uevent.c \
  $(PROJ_DIR)/module/peripheral_drv.c \
...
# Flash the program
flash: default
	@echo OpenOCD Flashing: $(OUTPUT_DIRECTORY)/nrf52832_xxaa.hex
	openocd -f ./script/openocd.cfg

# Flash softdevice
flash_softdevice:
	@echo Flashing: s132_nrf52_7.2.0_softdevice.hex
ifneq (,$(filter Windows%,$(OS)))
	openocd -f ./script/sd_path_windows.cfg -f ./script/openocd_softdevice.cfg
else
	openocd -f ./script/sd_path_posix.cfg -f ./script/openocd_softdevice.cfg
endif

jlink_flash: default
	@echo jlink Flashing: $(OUTPUT_DIRECTORY)/nrf52832_xxaa.hex
